 ...
 * <p>
 * <code>
 * CrawljaxConfiguration crawler = new CrawljaxConfiguration(); crawler.click("a");
 * crawler.click("div").withAttribute("class", "clickable"); crawler.dontClick("a").withText("id",
 * "logout"); crawler.dontClick("a").underXpath("//DIV[@id='header']");
 * </code>
 * </p>
 */
public final class CrawlElement {
     ...
     * //DIV[@id='foo'] includes the div, span and a elements //SPAN[@id='foo'] includes the span and
     * a elements //DIV[@class='link'] will not include any elements IMPORTANT: In the xpath
    ...
    /**
     * Restrict CrawlElement to include only HTML elements which have the specified text For example
     * 1) &lt;a&gt;Foo&lt;/a&gt; 2) &lt;a&gt;Bar&lt;/a&gt; 3) &lt;a&gt;Example 3a&lt;/a&gt;
    ...
    protected String escapeApostrophes(String text) {
        String resultString;
        if (text.contains("'")) {
            String stringBuilder = "concat('" + text.replace("'", "',\"'\",'") + "')";
