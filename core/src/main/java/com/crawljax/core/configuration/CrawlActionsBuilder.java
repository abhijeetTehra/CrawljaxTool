...
public class CrawlActionsBuilder {
     ...
     * &gt;a.../&lt; 2)
     * &lt;div/&gt; click("a") will only include 1 if clickOnce is true (default).
     * This set can be
    ...
    public CrawlElement click(String tagName) {
        ...
        System.out.println("Printing clicking crawltag");
     ...
     * {@link #dontClick(String)}. If no clicks are specified,
     * {@link #clickDefaultElements()} is
     * enabled.
     *
     ...
     * Specifies that
     * Crawljax should click all the default clickable elements. These include: All
     * anchor tags All
     * buttons
     */
    ...
    /**
     * Adds all HTML elements with a "click" event handler. Includes all default
     * elements. see
    ...
    /**
     * Set of HTML elements Crawljax will NOT click during crawling When an HTML is
     * present in the
     * click and dontClick sets, then the element will not be clicked. For example:
     * 1) &lt;a
     * href="#"&gt;Some text&lt;/a&gt; 2) &lt;a class="foo" .../&gt; 3) &lt;div
     * class="foo" .../&gt;
     * click("a") dontClick("a").withAttribute("class", "foo"); Will include only
